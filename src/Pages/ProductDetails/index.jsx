...
const productDetailsData = {
  productImages: [
    { src: "/assets/images/details/product_details_2.png", alt: "Thumb 1" },
    { src: "/assets/images/details/product_details_3.png", alt: "Thumb 2" },
    { src: "/assets/images/details/product_details_4.png", alt: "Thumb 3" },
    { src: "/assets/images/details/product_details_2.png", alt: "Thumb 4" },
    { src: "/assets/images/details/product_details_3.png", alt: "Thumb 5" },
    { src: "/assets/images/details/product_details_4.png", alt: "Thumb 6" },
  ],
  socialMediaLinks: {
  ...
  productData: {
    ...
    description:
      "Rejuvenate and refresh your skin with our Rosewater Hydrating Mist. Infused with the essence of roses, this luxurious mist provides a burst of hydration, soothing and revitalizing your skin.",
    size: "90 ml",
    stock: 152,
    ...
    voucherData: [
      ...
      {
        discount: "20% off",
        description: "skincare essential",
        code: "BEAUTY20",
    ...
    <>
      ...
      <div className="container">
          ...
          <div className="col-lg-6">
            <div className="cs_details cs_style_1">
              ...
              <ul className="cs_details_list_1 cs_mp_0">
                ...
                <li>
                  <span className="cs_fs_18 cs_primary_color">
                    {productDetailsData.productData.reviews}
                  </span>{" "}
                  Reviews
                </li>
                <li>
                  <span className="cs_fs_18 cs_primary_color">
                    {productDetailsData.productData.sold}
                  </span>{" "}
                  Sold
                </li>
              </ul>
              ...
              <p className="cs_product_price cs_fs_54 cs_semibold cs_accent_color mb-0">
                ${productDetailsData.productData.price.toFixed(2)}
              </p>
              <div className="cs_discount">
                <span className="cs_accent_strong_bg cs_white_color cs_fs_14 cs_light">
                  {productDetailsData.productData.discountPercentage}%
                </span>
                <small className="cs_fs_18">
                  ${productDetailsData.productData.discountedPrice.toFixed(2)}
                </small>
              </div>
              <Spacing lg={30} md={40} />
              <hr />
              ...
              <ul className="cs_details_list_2 cs_mp_0 cs_light">
                ...
                <li>
                  <b className="cs_semibold cs_primary_color">Size</b>{" "}
                  {productDetailsData.productData.size}
                </li>
                <li>
                  <b className="cs_semibold cs_primary_color">Stock</b>{" "}
                  {productDetailsData.productData.stock}
                </li>
              </ul>
              <Spacing lg={40} md={50} />
              <div className="cs_voucher_heading_1">
                <div className="cs_voucher_heading_icon">
                  <svg
                    width={39}
                    height={40}
                    viewBox="0 0 39 40"
                ...
                {productDetailsData.productData.voucherData.map(
                  (voucher, index) => (
                    <div className="col-sm-6" key={index}>
                      <div className="cs_voucher_card_1">
                        <div className="cs_voucher_text">
                          <h3 className="cs_secondary_font cs_accent_color cs_fs_36 cs_medium mb-0">
                            {voucher.discount}
                          </h3>
                          <p className="mb-0 cs_light">{voucher.description}</p>
                        </div>
                        <div className="cs_cupon_code_wrap">
                          <span className="cs_voucher_code cs_semibold cs_primary_color">
                            {voucher.code}
                          </span>
                          <button className="cs_voucher_btn cs_accent_color">
                            <svg
                              width={18}
                              height={18}
                              viewBox="0 0 18 18"
                          ...
                          <span className="cs_cupon_code_shape_1" />
                          <span className="cs_cupon_code_shape_2" />
                        </div>
                        <div className="cs_tooltip">
                          <span className="cs_tooltip_btn">
                            <svg
                              width={20}
                              height={20}
                              viewBox="0 0 20 20"
                          ...
                          <p className="cs_tooltip_body">{voucher.tooltip}</p>
                        </div>
                      </div>
                    </div>
                  )
        ...
        <div className="cs_tabs">
          <ul className="cs_tab_links cs_style_1 cs_mp_0 cs_fs_24 cs_medium cs_gray_bg">
        ...
        <div className="cs_review_card_wrap_1">
          <div className="cs_review_card_1">
            <div className="cs_review_card_left">
              <h3 className="cs_secondary_font cs_medium cs_fs_24 mb-0">
                {productDetailsData.reviewData.title}
              </h3>
              <Spacing lg={10} md={10} />
              ...
              <div className="cs_averate_rating_wrap_1">
                <div
                  className="cs_rating"
                  data-rating={productDetailsData.reviewData.averageRating}
                >
                  <Review
            ...
            <div className="cs_review_card_right">
