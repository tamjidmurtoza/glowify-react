...
const productDetailsData = {
  productImages: [
    { src: "/assets/images/details/product_details_8.png", alt: "Thumb 1" },
    { src: "/assets/images/details/product_details_8.png", alt: "Thumb 2" },
    { src: "/assets/images/details/product_details_8.png", alt: "Thumb 3" },
    { src: "/assets/images/details/product_details_8.png", alt: "Thumb 4" },
  ],
  productData: {
    ...
    description:
      "Purify and detoxify your skin with our Charcoal Detoxifying Mask. Formulated with activated charcoal, it draws out impurities, unclogs pores, and leaves your skin feeling fresh, clean, and revitalized.",
    size: "90 ml",
    stock: 182,
...
const ProductDetailsV3 = () => {
  PageTitle("Product-details-V3");
  const [quantity, setQuantity] = useState(1);
  const [activeFavo, setActivefavo] = useState(false);
  const [activeTab, setActiveTab] = useState("tab_2");
      ...
      <div className="container">
        ...
        <div className="row cs_gap_y_40">
          <div className="col-lg-5">
            <div className="cs_product_slider_wrap_1">
          ...
          <div className="col-lg-4">
            <div className="cs_details cs_style_1 p-0">
              ...
              <hr />
              <Spacing lg={20} md={25} />
              <div className="cs_wishlist_btn_1 cs_light">
                <button
                  className={`cs_like_btn cs_center ${
                    activeFavo ? "active" : ""
                  }`}
          ...
          <div className="col-lg-3">
            <div className="cs_product_details_info_1">
              ...
              <p className="cs_ternary_color cs_light mb-0">
              ...
              <Spacing lg={35} md={35} />
              <h2 className="cs_fs_16 cs_semibold cs_secondary_font mb-0">
                {productDetailsData.productData.voucherTitle}
              </h2>
              {productDetailsData.productData.voucherData.map((item, index) => (
                <div key={index}>
                  <Spacing lg={10} md={10} />
                  <div className="cs_voucher_card_3">
                    <div className="cs_voucher_text">
                      <h3 className="cs_secondary_font cs_accent_color cs_fs_24 cs_medium">
                        {item.code}
                      </h3>
